<?php
  ...
  # $def_long10   = -(51 + 57/60 + 51/60/60 + 0.59062474992);
    ...
    $lat10        = isset($_POST['lat10'   ]) ? $_POST['lat10'   ] : $def_lat10;
    $long10       = isset($_POST['long10'  ]) ? $_POST['long10'  ] : $def_long10;
    $zenith10     = isset($_POST['zenith10']) ? $_POST['zenith10'] : $def_zenith10;
